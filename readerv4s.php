...
function getRecommendations($id) {
    ...
    return array_slice($matches, 0, 10); // Ambil 10 miko bbi!
}
...
<head>
    ...
    <style>
        ...
        .miko-img { max-width: 95%; margin: 5px auto; display: block; border: 1px solid #D4AF37; }
        /* REKOMENDASI KECIL RAPI ASU! */
...
<body>
    <div id="header" class="navbar">
        ...
        <a href="https://nhentai.net/g/<?= $id ?>/pdf" class="btn btn-warning btn-sm" target="_blank" style="font-weight:bold;">SEDOT PDF</a>
    </div>
    ...
    <div class="reader-container">
        <?php for ($i = 1; $i <= $pages; $i++): ?>
            ...
            <img src="https://<?= $server ?>.nhentai.net/galleries/<?= $gid ?>/<?= $i ?>t.webp" 
                 onerror="this.src='https://<?= $server ?>.nhentai.net/galleries/<?= $gid ?>/<?= $i ?>.jpg';"
