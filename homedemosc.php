<?php
/**
 * ORIENTAL SEARCH v7.0 - MASTER ARATA EDITION [cite: 2026-02-22]
 * Fitur: Multi-Select, Fix Footer, Anti-Hitam, Smooth Infinite Scroll
 * Master Arata Pensi Edition - JANGAN DIKORUP ASU!
 */
require_once 'config.php';
$q = $_GET['q'] ?? ''; $page = $_GET['p'] ?? 1;
// Support buat multi-tags biar kaisar bisa panen kombinasi nuklir bbi!
...
<body class="bg-dark">
    ...
    <div class="dashboard-header border-bottom border-warning bg-black p-5 text-center">
        <div class="container d-flex justify-content-between align-items-center mb-4">
            ...
            <button class="btn btn-warning shadow-lg fw-bold" onclick="openGenre()">🔍 PILIH BANYAK GENRE</button>
        </div>
        ...
        <?php foreach ($matches as $m): ?>
            <div class="col-md-3 mb-4 miko-item"><div class="card-oriental h-100 text-center">
                ...
                <div class="p-3">
                    ...
                    <form action="index.php" method="POST"><input type="hidden" name="id" value="<?= $m[1] ?>"><button type="submit" class="btn btn-warning btn-sm w-100 mt-3 py-2 fw-bold">CULIK & SYNC</button></form>
                </div>
            </div></div>
        <?php endforeach; ?>
    ...
    <footer class="text-center text-warning p-4 border-top border-warning bg-black">
        🏮 ORIENTAL SEARCH v7.0 - EXCLUSIVE FOR MASTER MITSUKI ARATA 🏮
    </footer>
