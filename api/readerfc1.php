...
<head>
    ...
    <style>
        ...
        .reader-container { padding-top: 70px; }
        .miko-img { max-width: 95%; margin: 5px auto; display: block; border: 1px solid #D4AF37; background: #111; min-height: 500px; }
        .recom-section { margin-top: 50px; padding: 20px; border-top: 2px solid #D4AF37; background: #111; }
        .recom-grid { display: grid; grid-template-columns: repeat(5, 1fr); gap: 10px; }
        .recom-item img { width: 100%; height: 200px; object-fit: cover; border: 1px solid #D4AF37; border-radius: 5px; }
        .recom-title { font-size: 0.7rem; color: #FFD700; height: 30px; overflow: hidden; margin-top: 5px; }
    </style>
</head>
<body>
    ...
    <div class="reader-container">
        <?php for ($i = 1; $i <= $pages; $i++): ?>
            ...
            <img src="https://i<?= $srv ?>.nhentai.net/galleries/<?= $gid ?>/<?= $i ?>.jpg" 
                 onerror="this.onerror=function(){this.src='https://i<?= $srv ?>.nhentai.net/galleries/<?= $gid ?>/<?= $i ?>.png'; this.onerror=function(){this.src='https://i<?= $srv ?>.nhentai.net/galleries/<?= $gid ?>/<?= $i ?>.webp'; this.onerror=function(){this.src='https://t<?= $srv ?>.nhentai.net/galleries/<?= $gid ?>/<?= $i ?>t.jpg';}}};" 
