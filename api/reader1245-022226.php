<?php
/**
 * ORIENTAL READER v5.0 - ANTI-HITAM SAKTI
...
// ===== SAKTI GID AUTO-REPAIR =====
// Kalau GID kosong atau ngaco, culik paksa dari API bbi!
...
<head>
    ...
    <style>
        ...
        /* === CATATAN: JANGAN SENTUH! ANTI-HITAM! === */
        .navbar { 
...
<body>
    <div id="header" class="navbar">
        ...
        <span style="color:#fff;">Miko ID: <?= $id ?> (GID: <?= $gid ?>)</span>
