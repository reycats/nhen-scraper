<?php
/**
 * ORIENTAL DASHBOARD v2.0 - ANTI-HITAM EDITION [cite: 2026-02-22]
 * Khusus Master Mitsuki Arata
 */
require_once 'config.php';
require_once 'scraper.php';

// FITUR HAPUS BOOKMARK PERMANEN
...
<head>
    ...
    <style>
        /* === CATATAN BUAT AI: JANGAN DIUBAH! BIKIN LAYAR ITEM! [cite: 2026-02-22] === */
        /* Paksa ilangin overlay dongo modal bootstrap yang bikin layar macet hitam! */
        .modal-backdrop, .modal-backdrop.show { display: none !important; position: static !important; }
        body.modal-open { overflow: auto !important; padding-right: 0 !important; }
        /* Pastiin background beneran item tapi konten keliatan asu! */
        body { background: #000 !important; color: #D4AF37 !important; overflow-x: hidden !important; position: relative !important; }
