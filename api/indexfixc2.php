                    ...
                    <div class="col-md-3 mb-4"><div class="card-oriental h-100">
                        ...
                        <div class="p-2 text-center">
                            ...
                            <div class="d-flex gap-1 mt-2">
                                <a href="reader.php?id=<?= $b['miko_id'] ?>&gid=<?= $b['media_id'] ?>&pages=<?= $b['pages'] ?>" class="btn btn-warning btn-sm w-50 fw-bold">BACA HD</a>
                                <a href="downloader.php?id=<?= $b['miko_id'] ?>&gid=<?= $b['media_id'] ?>&pages=<?= $b['pages'] ?>" class="btn btn-danger btn-sm w-50 fw-bold">SEDOT ZIP</a>
                            </div>
                        </div>
                    </div></div>
                <?php endforeach; ?>
                ...
                <div class="col-md-4 mb-4"><div class="card-oriental">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex gap-2">
                            <a href="reader.php?id=<?= $card['id'] ?>&gid=<?= $card['gid'] ?>&pages=<?= $card['pages'] ?>" class="btn btn-oriental w-50">BACA</a>
                            <a href="downloader.php?id=<?= $card['id'] ?>&gid=<?= $card['gid'] ?>&pages=<?= $card['pages'] ?>" class="btn btn-warning btn-sm w-50 fw-bold" style="background:#D4AF37;color:#000;">SEDOT ZIP</a>
                        </div>
                    </div>
                </div></div>
            <?php endforeach; ?>
